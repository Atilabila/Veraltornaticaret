                                ...
                                <div className="grid sm:grid-cols-2 gap-4">
                                    <div className="sm:col-span-2">
                                        ...
                                        <input
                                            ...
                                            className={`w-full h-12 px-4 border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary ${formErrors.fullName ? 'border-destructive' : 'border-border'}`}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full h-12 px-4 border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary ${formErrors.email ? 'border-destructive' : 'border-border'}`}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full h-12 px-4 border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary ${formErrors.phone ? 'border-destructive' : 'border-border'}`}
                                    ...
                                    <div className="sm:col-span-2">
                                        ...
                                        <textarea
                                            ...
                                            className={`w-full min-h-[100px] px-4 py-3 border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary resize-none ${formErrors.address ? 'border-destructive' : 'border-border'}`}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full h-12 px-4 border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary ${formErrors.city ? 'border-destructive' : 'border-border'}`}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full h-12 px-4 border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary ${formErrors.district ? 'border-destructive' : 'border-border'}`}
                                            placeholder="Kadıköy"
                                        />
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full h-12 px-4 border border-border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary"
                                            placeholder="34000"
                                        />
                                    </div>
                                    ...
                                    <div className="sm:col-span-2">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full min-h-[80px] px-4 py-3 border border-border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary resize-none"
                            ...
                            <section className="bg-card border border-border rounded-xl p-6">
                                ...
                                <div className="flex gap-4 mb-6">
                                    ...
                                    >
                                        ...
                                        <p className="text-sm text-muted-foreground">Şahıs faturası</p>
                                    </button>
                                    <button
                                        type="button"
                                    ...
                                    >
                                        ...
                                        <p className="text-sm text-muted-foreground">Şirket faturası</p>
                                    </button>
                                </div>
                        ...
                        <div className="lg:col-span-1">
                            <div className="sticky top-28 bg-card border border-border rounded-xl p-6 space-y-6">
                                ...
                                <p className="text-xs text-muted-foreground text-center">
                                    Siparişi tamamlayarak <Link href="/kosullar" className="underline">Satış Sözleşmesi</Link>'ni kabul etmiş olursunuz.
                                </p>
                            </div>
                        </div>
                    </div>
