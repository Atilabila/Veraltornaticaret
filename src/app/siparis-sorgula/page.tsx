        ...
        <main className="min-h-screen bg-background pt-32 pb-16">
            <div className="container max-w-xl mx-auto px-4">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-muted/50 p-6 rounded-xl border border-border/50 flex items-start gap-4">
                        <div className="w-10 h-10 bg-background rounded-lg flex items-center justify-center shrink-0 shadow-sm">
                            <Package className="w-5 h-5 text-primary" />
                        </div>
                        <div>
                            <h3 className="font-bold mb-1">Hesabım Yok?</h3>
                            <p className="text-sm text-muted-foreground">Siparişinizi sorgulamak için üye olmanıza gerek yoktur.</p>
                        </div>
                    </div>
                    <div className="bg-muted/50 p-6 rounded-xl border border-border/50 flex items-start gap-4">
                        <div className="w-10 h-10 bg-background rounded-lg flex items-center justify-center shrink-0 shadow-sm">
                        ...
                        <div>
                            <h3 className="font-bold mb-1">Yardım Lazım?</h3>
                            <p className="text-sm text-muted-foreground">Bilgilerinize ulaşamıyorsanız <Link href="/iletisim" className="text-primary underline">destek</Link> alın.</p>
                        </div>
                    </div>
                </div>
            </div>
