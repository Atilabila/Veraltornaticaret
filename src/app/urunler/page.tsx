...
import { ShoppingCart, X, Check, Filter, ArrowRight, Settings, Maximize2 } from "lucide-react";
...
const CATEGORY_LABELS: Record<string, string> = {
    ...
    "ARABALAR": "OTOMOBİL",
    "ATATÜRK": "ATATÜRK SERİSİ",
    "MOTOR": "MOTOSİKLET",
    "RETRO": "KARAKTERLER",
    "YAPAY CITY": "ŞEHİR VE KENT",
    "KARAKTERLER": "KARAKTERLER"
};

const categories = ["ALL_LOGS", ...Array.from(new Set(PRODUCTS.map(p => p.category)))];
            ...
            <header className="fixed top-0 left-0 w-full z-50 bg-white border-b-4 border-black">
                <div className="container-brutal py-4 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-4">
                        <button className="btn-mechanical p-3 !p-2 !shadow-[2px_2px_0px_0px_black] active:translate-y-1 active:translate-x-1 active:shadow-none">
