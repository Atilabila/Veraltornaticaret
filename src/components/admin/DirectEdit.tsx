    ...
    return (
        <div className={`relative group/edit ${className}`}>
            ...
            <div className="hidden md:flex absolute inset-0 bg-black/5 opacity-0 group-hover/edit:opacity-100 transition-all duration-300 z-[60] items-center justify-center backdrop-blur-[1px] pointer-events-none">
                <div className="border border-[var(--color-brand-accent)]/30 absolute inset-0" />
            </div>
            ...
            <div className="absolute top-4 right-4 z-[70]">
                <Link
                    href={`/admin?tab=${tab}`}
                    className="flex items-center gap-2 px-3 py-2 bg-[var(--color-brand-accent)] text-white rounded-full md:rounded-lg font-black text-[10px] uppercase tracking-tighter shadow-xl hover:scale-110 active:scale-95 transition-all md:opacity-0 md:group-hover/edit:opacity-100"
                >
