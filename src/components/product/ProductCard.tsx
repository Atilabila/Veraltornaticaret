...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
    ...
    return (
        <div className="group relative flex flex-col h-full bg-[#111827] border border-white/5 transition-all duration-300 hover:border-[#D4AF37]/50 shadow-lg hover:shadow-[0_0_30px_rgba(212,175,55,0.1)]" style={{ transform: 'translateZ(0)', willChange: 'transform, border-color' }}>
            {/* Header Metadata */}
