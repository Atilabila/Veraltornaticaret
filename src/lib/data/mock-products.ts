...
export const MOCK_PRODUCTS: MetalProduct[] = [
    {
        id: "1",
        name: "Kalaylı Teneke Tel",
        slug: "kalayli-teneke-tel",
        sku: "TEL-KALY-01",
        description: "Yüksek mukavemetli, paslanmaya karşı dayanıklı kalay kaplama teneke tel. Endüstriyel kullanım için idealdir.",
        price: 1500,
    ...
    },
    {
        ...
        is_active: true,
        is_showcase: true,
        material: "Paslanmaz Metal",
        paint: "Polisaj",
        installation: "Boru Sistemi",
        origin: "Yerli Üretim (İzmir)",
        stock_quantity: 300,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString(),
